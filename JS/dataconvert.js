...
dataselect.prototype.main=function (value) {
    ...
    function main(error, jsondata) {
        ...
        infos = new Infos(svg, 0.76*width, 0.37*height, 0.15*width, 0.6*height, data.players.team0);
        ...
        var f2 = new Field(svg, 0.76*width, 0.01*height, 0.15*width, 0.35*height, "playerfield", 1, 1,1);
