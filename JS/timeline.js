...
matchinfo = function (svg, field, data, width, height, value) {
    this.addBody();
    ...
    for (let i = 0; i < data.length; i++) {
        let g = this.g_sequence.append("g")
            ...
            .on("dblclick", function () {
                ...
                if(that.value === "data/MatchData_ChinaVsQatar.json"){
                    console.log("Qqqq")
                    videoPlayer.setVideo(`${folderPath}/video/cvq.mkv`)
